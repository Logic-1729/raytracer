...
impl Vec3 {
    ...
    pub fn default() -> Self { Self::new(0.0, 0.0, 0.0)}
    ...
    pub fn cross(u: &Vec3, v: &Vec3) -> Vec3 { Vec3::new(u.y * v.z - u.z * v.y,u.z * v.x - u.x * v.z,u.x * v.y - u.y * v.x,)}
    ...
    pub fn random_on_hemisphere(normal: &Vec3) -> Self {
        ...
        if Vec3::dot(&on_unit_sphere,&normal) > 0.0 { on_unit_sphere } else { -on_unit_sphere }
    }

    pub fn reflect(v: &Vec3, n: &Vec3) -> Vec3 { *v - 2.0 * Vec3::dot(v, n) * *n}
...
impl AddAssign for Vec3 {
    fn add_assign(&mut self, other: Self) { *self = Self { x: self.x + other.x, y: self.y + other.y, z: self.z + other.z,};}
}

impl MulAssign<f64> for Vec3 {
    fn mul_assign(&mut self, t: f64) { *self = Self {x: self.x * t,y: self.y * t,z: self.z * t,};}
}
